...
def test_usage_spans_errors():
    ...
    with patch.object(RichHelpFormatterPlus, "_rich_usage_spans", side_effect=ValueError):
...
def test_django_rich_help_formatter():
    ...
    class DjangoRichHelpFormatter(DjangoHelpFormatter, RichHelpFormatterPlus):
